...
def make_parser():
    ...
    # ArTIST
    parser.add_argument("--num_sampling", type=int, default=50, help="number of inpainted tracklets")
    parser.add_argument("--num_cluster", type=int, default=1024, help="for ArTIST model")
    parser.add_argument("--t_trs", type=int, default=2, help="for Tracklet Rejection Scheme")
    parser.add_argument("--iou_thre_trs", type=float, default=0.5, help="for Tracklet Rejection Scheme")
    parser.add_argument("--hidden_state", type=int, default=256, help="for MA-Net")
